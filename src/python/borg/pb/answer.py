...
class PB_Answer(Rowed):
    """
    An answer to a pseudo-Boolean instance.
    """
    ...
    def get_new_row(self, session):
        ...
        from borg.data import PB_AnswerRow

        answer_row = PB_AnswerRow(self.satisfiable, self.certificate)
